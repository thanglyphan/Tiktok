(function() {
    ...
    vexFactory = function($) {
        ...
        $(function() {
            ...
            animationEndSupport = s.animation !== void 0 ||
                s.WebkitAnimation !== void 0 ||
                s.MozAnimation !== void 0 ||
                s.MsAnimation !== void 0 ||
                s.OAnimation !== void 0;
            return $(window)
                .bind("keyup.vex",
                    function(event) {
        ...
        return vex = {
            ...
            open: function(options) {
                ...
                if (options.overlayClosesOnClick) {
                    options.$vexOverlay.bind("click.vex",
                        function(e) {
                            if (e.target !== this) {
                                return;
                            }
            ...
            closeByID: function(id) {
                ...
                hasAnimation = $vexContent.css("animationName") !== "none" &&
                    $vexContent.css("animationDuration") !== "0s";
                if (animationEndSupport && hasAnimation) {
                    if (beforeClose() !== false) {
                        $vex.unbind(vex.animationEndEvent)
                            .bind(vex.animationEndEvent,
                                function() {
                                    return close();
                                })
            ...
            showLoading: function() {
                vex.hideLoading();
                return $("body")
                    .append("<div class=\"vex-loading-spinner " + vex.defaultOptions.className + "\"></div>");
            }
        };
    };
