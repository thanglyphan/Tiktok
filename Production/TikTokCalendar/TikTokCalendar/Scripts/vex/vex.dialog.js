    ...
    vexDialogFactory = function($, vex) {
        ...
        dialog.open = function(options) {
            ...
            if (options.focusFirstInput) {
                $vexContent
                    .find('button[type="submit"], button[type="button"], input[type="submit"], input[type="button"], textarea, input[type="date"], input[type="datetime"], input[type="datetime-local"], input[type="email"], input[type="month"], input[type="number"], input[type="password"], input[type="search"], input[type="tel"], input[type="text"], input[type="time"], input[type="url"], input[type="week"]')
                    .first()
                    .focus();
            }
            return $vexContent;
        ...
        dialog.prompt = function(options) {
            ...
            defaultPromptOptions = {
                ...
                input: "<input name=\"vex\" type=\"text\" class=\"vex-dialog-prompt-input\" placeholder=\"" +
                    (options.placeholder || "") +
                    "\"  value=\"" +
                    (options.value || "") +
                    "\" />"
                ...
                function(index, button) {
                    ...
                    $button = $("<button type=\"" + button.type + "\"></button>")
                        ...
                        .addClass(button.className +
                            " vex-dialog-button " +
                            (index === 0 ? "vex-first " : "") +
                            (index === buttons.length - 1 ? "vex-last " : ""))
                        .bind("click.vex",
                            function(e) {
                                if (button.click) {
                                    return button.click($(this)
                                        .parents(vex.getSelectorFromBaseClass(vex.baseClassNames.content)),
                                        e);
                                }
                            });
